---
name: jk-solution-and-product-guide
description: The jk-solution-and-product-guide skill provides users with clear, concise information about solutions (services capabilities) and product features in jinko (jk for short) to solve the users scientific and modeling objectives. Use this skill whenever you need guidance on finding models in the library to help get a fast start or understand jinko features to accelerate your integrated modeling strategy.
metadata:
  author: Nova In Silico
license: MIT
---

# Jk solution and product guide
